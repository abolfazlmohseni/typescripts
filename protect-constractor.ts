class Person {
    ...
    //    private constructor(name: string, lastname: string, phone: number, age: number) {
    //         this.name = name
    ...
    protected constructor(name: string, lastname: string, phone: number, age: number) {
        this.name = name
        this.lastname = lastname
        this.phone = phone
        this.age = age
...
class Student extends Person {
    ...
    public constructor(name: string, lastname: string, phone: number, age: number, lesson: string[]) {
