...
let text2 = input; // type = string
let text = input; // type = string
...
const linkElem = document.quetySelector(".link");
//const linkElem = <HTMLAnchorElement>document.quetySelector(".link") 
console.log(linkElem.href);
const inputElem = document.quetySelector("input");
const inputElem = document.quetySelector("input");
...
bol = true;
let list = [10, 12, 154];
let list2 = ["test1", "test5", "test4", "test2"];
let list3 = ["test", 12, 56, 345, "test2"];
let userAge = 18;
// userAge = 34
userAge = 20;
let anyVar = 15;
